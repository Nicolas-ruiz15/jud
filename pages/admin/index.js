// pages/admin/index.js - CON WIDGET DE TICKETS
...
const AdminDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const ticketsResponse = await fetch('/api/tickets/stats?period=7');
      const ticketsData = await ticketsResponse.json();

      setStats({
        ...statsData.data,
        totalTickets: ticketsData.success ? ticketsData.data.summary.total_tickets : 0,
        urgentTickets: ticketsData.success ? ticketsData.data.urgent_tickets?.length || 0 : 0,
        loading: false
      });
  ...
  const StatCard = ({ title, value, icon, color, trend, href }) => (
    <div className="bg-white overflow-hidden shadow-soft rounded-lg hover:shadow-md transition-shadow">
      <div className="p-5">
  ...
  return (
    <AdminLayout title="Dashboard">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <div className="bg-white shadow-soft rounded-lg p-6">
          ...
          <div className="space-y-3">
              ...
              <div className="flex items-center p-3 bg-red-50 rounded-lg">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-red-800">
                    {stats.urgentTickets} tickets urgentes requieren atención
                  </p>
                  <Link href="/admin/tickets?priority=high" className="text-xs text-red-600 hover:text-red-800">
            ...
            {stats.lowStockProducts > 0 && (
              <div className="flex items-center p-3 bg-orange-50 rounded-lg">
                ...
                <div className="ml-3">
                  ...
                  <Link href="/admin/productos?filter=low_stock" className="text-xs text-orange-600 hover:text-orange-800">
                    Ver productos →
                  </Link>
                </div>
              </div>
            ...
            {stats.pendingOrders === 0 && stats.lowStockProducts === 0 && stats.urgentTickets === 0 && (
        ...
        <div className="bg-white shadow-soft rounded-lg p-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Link href="/admin/tickets" className="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              <div className="w-8 h-8 bg-purple-500 rounded flex items-center justify-center text-white text-sm">
                🎫
              </div>
              <span className="ml-2 text-sm font-medium text-gray-700">Ver Tickets</span>
            </Link>
      ...
      {/* Widget de Tickets y contenido existente */}
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-8">
        
        {/* Widget de Tickets - Ocupa 1 columna */}
        <div className="xl:col-span-1">
          <TicketsWidget />
        </div>
        
        {/* Órdenes recientes - Ocupa 2 columnas */}
